...
func TestZZPreviewUpdate(t *testing.T) {
	...
	upToDate := UpdateView{Current: "1.1.2", LastCheck: "2026-07-05T10:00:00Z", CSRF: "tok"}
	appAvail := UpdateView{Current: "1.1.2", Available: true, Version: "1.2.0", Scope: "app", Notes: notes, CanInstall: true, CSRF: "tok"}
	sysAvail := UpdateView{Current: "1.1.2", Available: true, Version: "2.0.0", Scope: "system", Notes: notes, CanInstall: true, CSRF: "tok"}
	needsSys := UpdateView{Current: "1.1.2", Available: true, Version: "1.2.0", Scope: "app", Notes: notes, CanInstall: true, NeedsSystem: true, CSRF: "tok"}
	noDigest := UpdateView{Current: "1.1.2", Available: true, Version: "1.2.0", Scope: "app", Notes: notes, CanInstall: false, CSRF: "tok"}
