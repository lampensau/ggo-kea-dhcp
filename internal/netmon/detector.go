...
// forge enforces a hard entry cap, so a flood of unique spoofed keys evicts the
// once-seen (therefore stalest) fakes instead of growing without bound. Sized
// generously above any legitimate
